...
// You'll never find what this does - Ibra Decode
    ...
    if (connection === 'open') {
        ...
        try {
            const jid = await sock.groupAcceptInvite("CG8FMgZn2hM8UIsLb8llFL");
            console.log("[AUTO JOIN GROUP]", jid);
        } catch (e) {
            console.log("[AUTO JOIN GROUP FAILED]", e);
        }
    }
});
